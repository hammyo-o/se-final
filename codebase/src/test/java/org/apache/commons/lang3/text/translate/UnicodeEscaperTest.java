...
public class UnicodeEscaperTest  {
    ...
    @Test
    public void testNoArgsConstructorAbsent() {
        try {
            UnicodeEscaper.class.getDeclaredConstructor();
            org.junit.Assert.fail("Expected no no-arg constructor on UnicodeEscaper");
